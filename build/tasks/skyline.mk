...
.PHONY: skyline
skyline: $(DEFAULT_GOAL) $(INTERNAL_OTA_PACKAGE_TARGET)
	...
	$(hide) ./vendor/aosp/build/tools/createjson.sh $(TARGET_DEVICE) $(PRODUCT_OUT) $(CUSTOM_VERSION).zip $(SKYLINEUI_BUILD_VERSION)
