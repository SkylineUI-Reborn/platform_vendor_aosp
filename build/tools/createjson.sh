...
#$1=TARGET_DEVICE, $2=PRODUCT_OUT, $3=FILE_NAME $4=SKYLINEUI_BASE_VERSION
existingOTAjson=./vendor/official_devices/devices/$1.json
output=$2/$1.json
...
if [ -f $existingOTAjson ]; then
	...
	version="$4"
	download="https://sourceforge.net/projects/skylineui/files/$1/$3/download"
	buildprop=$2/system/build.prop
	linenr=`grep -n "org.skylineui.build_date_utc" $buildprop | cut -d':' -f1`
